...
const SearchSection = () => {
  ...
  return (
    <section className="flex flex-col items-start self-stretch pt-[54px] pb-[134px] px-[272px] max-md:pt-10 max-md:pb-[100px] max-md:px-[150px] max-sm:pt-[30px] max-sm:pb-[60px] max-sm:px-5">
